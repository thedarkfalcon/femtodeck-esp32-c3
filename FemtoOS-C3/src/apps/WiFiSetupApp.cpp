...
String WiFiSetupApp::buildPage(const char* notice) const {
  ...
  html += F("<p class='muted'>Save up to five WiFi networks. Setup WiFi password is <strong>femtodeck</strong>. Testing and deleting saved networks is done from the Femto OS WiFi Settings app.</p>");
  ...
  html += F("<p class='muted'>After saving, return to Femto OS. Hold the device button to leave setup.</p>");
